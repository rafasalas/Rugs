...
public class muestracolor extends View {
   ...
   public float[] hsv = new float[3];
    ...
    vectordraw muestra_1, muestra_2,muestra_3;
    public muestracolor(Context context, AttributeSet atributos) {
        ...
        muestra_3=new vectordraw(context);
        muestra_3.loadsvg("muestra_3","drawable","com.rafasalas.rugs");
        hsv[0]=hsv[1]=hsv[2]=0;
